...
function wmpStop(){
 ...
 Exobud.close();
 disp1.innerHTML="最新歌曲 MP3 播放已停止";
 if(blnStatusBar){window.status=('JiStar MD');return true;}
}
...
// 12(MediaOpening) 13(MediaOpen) 20(MediaWaiting) 21(OpeningUnknownURL)
 ...
 if(f==8){capText.innerHTML="JiStar MD";}
 if(f==13){
	...
	strMmInfo= "Media (Title) : " + strTitle + " (JiStar MD:" + strType +")" + "\n"
	...
	strMmInfo= strMmInfo + "Media (Duration) : " +strDur +"\n\n";
        strMmInfo= strMmInfo + "“梦缘设计:网页制作.程序美化.平面设计” \n";
	strMmInfo= strMmInfo + "梦缘设计:网页制作.程序美化.平面设计\n";
...
function evtWmpError(){
 ...
 if(intErrCnt<=3){
	disp2.innerHTML="梦缘设计:网页制作.程序美化.平面设计("+intErrCnt+")";
	var msg="(梦缘设计:网页制作.程序美化.平面设计:" + intErrCnt +") " +cActTit;
	disp1.innerHTML="梦缘设计:网页制作.程序美化.平面设计" +cActTit;
	if(blnStatusBar){window.status=(msg);}
...
function evtStop(){
	...
	imgChange("playt",0);
	imgChange("scope",0);
	disp1.innerHTML="JiStar MD";
	if(blnStatusBar){window.status=('梦缘设计:网页制作.程序美化.平面设计');return true;}
}
...
function showTLab(){
 ...
 if(ps==2 || ps==3){
	...
	if(blnElaps){disp2.innerHTML= cps+" | "+durs;
		...
		if(ps==2){msg="(梦缘设计:网页制作.程序美化.平面设计) "+ msg;}
...
function waitMsg(){
 capText.innerHTML="梦缘设计:网页制作.程序美化.平面设计 Captioning(SMI)";
 if(intExobudStat ==1){disp1.innerHTML="梦缘设计:网页制作.程序美化.平面设计";}
 if(intExobudStat ==2){disp1.innerHTML="梦缘设计:网页制作.程序美化.平面设计";}
 if(blnStatusBar){
	if(intExobudStat ==1){window.status=('梦缘设计:网页制作.程序美化.平面设计');return true;}
	if(intExobudStat ==2){window.status=('梦缘设计:网页制作.程序美化.平面设计'); return true;}
 }
}


function openPlist() { 
	window.open("jistarpl.html" , "mplist", " width=280 , height=500 ,scrollbars=auto , resizable=no , copyhistory=no");
}
...
function vizExobud(){
  window.open("http://yqlove.c361.com/web","vizExobud");
}
